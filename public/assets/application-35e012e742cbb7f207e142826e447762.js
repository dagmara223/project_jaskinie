...
$(function() { 
/*
	var map = L.map('map').setView([52.23, 21.03], 10);
...
L.Icon.Default = L.Icon.extend({
	...
	_getIconUrl: function (name) {
		...
		if (L.Browser.retina && name === 'icon') {
			return "/assets/marker-icon-2x-610ba4bc360ba0b0f248acbf534250b1.png";
		}

		if (name == 'shadow') {
			return "/assets/marker-shadow-868f760aed944c3ea7cec054ab52fe0d.png";
		} else {
			return "/assets/marker-icon-5b94824d07c0c864f23f8d42e17cf947.png";
		}
	}
});
